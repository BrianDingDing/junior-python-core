"""
    函数参数
    形式参数: 约束实参.
        位置形参: 实参必填. def 函数名(参数1, 参数2)
        默认形参: 实参可选. def 函数名(参数1=数据, 参数2=数据)
        星号元组形参: 多位置实参合一元组. def 函数名(*args)
        双星号字典形参: 多关键字实参合一字典. def 函数名(**kwargs)
        命名关键字形参: 必须用关键字实参. def 函数名(*args, 参数1) / def 函数名(*, 参数1)
    实际参数: 传递方式.
        位置实参: 按顺序对应. 函数名(数据1, 数据2)
        关键字实参: 按名称对应. 函数名(参数2=数据2)
        序列实参: 一序列拆分为多参数, 拆完后按顺序给. 函数名(*序列)
        字典实参: 一字典拆分为多参数, 拆完后按名字给. 函数名(**字典)
"""
